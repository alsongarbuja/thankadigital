  ...
  return (
    <CustomWidthWrapper>
      ...
      <p className="font-medium text-gray-600">
        Meet our teams who are working together to make great products
      </p>
      ...
      <div className="grid items-center grid-cols-1 gap-4 mt-8 md:grid-cols-2">
        <div className="">
          ...
          <p className="w-full text-lg text-justify">
            ...
            cutting-edge technology. We specialize in providing customized
            solutions that cater to your unique business needs. Our expertise
            ranges from web development and mobile app design to digital
            marketing. Trust us to transform your ideas into reality and propel
      ...
      <div className="mt-10">
        ...
        {teams.designers.length > 0 && (
          <h6 className="mt-8 text-center">Designers</h6>
        )}
        <MemberWrapper>
        ...
        {teams.marketers.length > 0 && (
          <h6 className="mt-8 text-center">Marketering Team</h6>
        )}
        <MemberWrapper>
        ...
        {teams.testers.length > 0 && (
          <h6 className="mt-8 text-center">Testers</h6>
        )}
        <MemberWrapper>
        ...
        {teams.others.length > 0 && (
          <h6 className="mt-8 text-center">Others Members</h6>
        )}
        <MemberWrapper>
  ...
  return (
    <div className="relative w-full md:w-[18%] h-[350px] group overflow-hidden">
      <Image
        ...
        width={250}
        height={350}
        className="object-cover w-full h-full bg-blue-100 rounded-lg"
      />
      <div className="absolute bottom-0 z-10 w-full text-white -translate-x-1/2 left-1/2"></div>
      <div className="absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full gap-4 text-white transition-all ease-in-out opacity-0 group-hover:opacity-100 bg-primary_blue/50">
        <div className="w-full text-center">
          ...
          <p className="py-2 font-semibold bg-primary_red/20">
            {member.position}
          </p>
        </div>
        <div className="flex gap-4">
          {member.portfolio && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label={`link to portfolio of ${member.name}`}
            >
              <Globe />
            </a>
          )}
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label={`link to linkedin of ${member.name}`}
          >
            <Linkedin />
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label={`link to github of ${member.name}`}
          >
            <GitHub />
          </a>
        </div>
